        ...
        <div class="card" style="background-color: rgb(23, 23, 24)">
                ...
                <form action="{{ route('users.update', $user) }}" method="POST">
                    ...
                    <div class="form-group mr-2 ml-2">
                        ...
                        <input id="name" type="text" class="form-control" name="name" value="{{ $user->name }}" class="form-control">
                    </div>
                    <div class="form-group mr-2 ml-2">
                        <label for="email">Email:</label>
                        <input id="email" type="text" class="form-control" name="email" value="{{ $user->email }}" class="form-control">
                    </div>
